...
from app.config import APP_ENV, DATABASE_URL, OWNER_PASSWORD, RESELLER_PASSWORD, TEAM_LEADER_PASSWORD, database_dsn
...
def main():
    if APP_ENV == "production":
        raise SystemExit(
            "Refusing to reset and seed a production database. "
            "Run tools/bootstrap_owner.py to create the initial owner instead."
        )
